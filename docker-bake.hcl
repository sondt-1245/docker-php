...
group "default" {
    targets = [
        ...
        "7_3_33-fpm-buster",
        "7_3_33-nginx-buster",
        "7_3_33-cli-alpine3_16",
        "7_3_33-fpm-alpine3_16",
        "7_3_33-nginx-alpine3_16",
...
target "7_3_33-cli-alpine3_16" {
    context = "./7.3/alpine3.16/cli"
    cache-from = [
        "${REGISTRY}/${REPO}:7.3-cli-alpine3.16"
    ]
    tags = [
        "${REGISTRY}/${REPO}:7.3-cli-alpine3.16",
        ...
        "${REGISTRY}/${REPO}:7.3.33-cli-alpine3.16",
...
target "7_3-cli-alpine3_16" {
    inherits = ["7_3_33-cli-alpine3_16"]
}

target "7_3_33-fpm-alpine3_16" {
    context = "./7.3/alpine3.16/fpm"
    cache-from = [
        "${REGISTRY}/${REPO}:7.3-fpm-alpine3.16"
    ]
    tags = [
        "${REGISTRY}/${REPO}:7.3-fpm-alpine3.16",
        "${REGISTRY}/${REPO}:7.3-fpm-alpine",
        "${REGISTRY}/${REPO}:7.3.33-fpm-alpine3.16",
        "${REGISTRY}/${REPO}:7.3.33-fpm-alpine",
    ]
}

target "7_3-fpm-alpine3_16" {
    inherits = ["7_3_33-fpm-alpine3_16"]
}

target "7_3_33-nginx-alpine3_16" {
    context = "./7.3/alpine3.16/nginx"
    cache-from = [
        "${REGISTRY}/${REPO}:7.3-nginx-alpine3.16"
    ]
    tags = [
        "${REGISTRY}/${REPO}:7.3-nginx-alpine3.16",
        "${REGISTRY}/${REPO}:7.3-nginx-alpine",
        "${REGISTRY}/${REPO}:7.3.33-nginx-alpine3.16",
        "${REGISTRY}/${REPO}:7.3.33-nginx-alpine",
    ]
}

target "7_3-nginx-alpine3_16" {
    inherits = ["7_3_33-nginx-alpine3_16"]
}
